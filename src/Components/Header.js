    ...
    return(
        <header className="bg-[#ff5200] font-serif">
            <div className="flex justify-between container mx-auto py-8">
                ...
                <div className=" text-base text-white font-bold flex gap-10 items-center">
            ...
            <div className="pt-16 pb-8 relative">
                ...
                <div className="max-w-[60%] text-5xl font-bold text-white container mx-auto text-center">

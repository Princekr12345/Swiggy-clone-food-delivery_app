    ...
    return(
        ...
        <div className="flex w-full justify-between mb-2 pb-2">
            ...
            <div className="w-[20%] relative h-42">
                ...
                {
                    count===0?( <button className="absolute bottom-1 left-20 rounded-xl text-2xl text-green-600 px-4 py-2 shadow-md border border-white bg-white " onClick={()=>handAdditems()}>ADD</button>):(
                        <div className="flex gap-3 absolute bottom-1 left-20 rounded-2xl text-2xl text-green-600 px-4 py-2 shadow-md border border-white bg-white ">
